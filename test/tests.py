...
tests = [ {'description': 'PORTA: 0x00 => PORTC: 0x40',
    ...
    {'description': 'PORTA: 0xFF => PORTC: 0x3F',
    ...
    {'description': 'PORTA: 0x23 => PORTC: 0x70',
    ...
    {'description': 'PORTA: 0x98 => PORTC: 0x3C',
    'steps': [{'inputs': [('PINA', 0x98)], 'iterations': 1}],
        #{'inputs': [('PINB',0xFF)], 'iterations': 1}],
    'expected': [('PORTC', 0x3C)],
    },
    {'description': 'PORTA: 0x9A => PORTC: 0x3E',
    'steps': [{'inputs': [('PINA', 0x9A)], 'iterations': 1}],
        #{'inputs': [('PINB',0xFF)], 'iterations': 1}],
    'expected': [('PORTC', 0x3E)],
    },
    ]
